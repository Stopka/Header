...
use Stopka\Assetor\Package\BasePackage;
...
class AssetsCollector extends Object {
    ...
    public function addFile($group, $file) {
    }
     ...
     */
    public function registerPackage(string $name, BasePackage $package) {
     ...
     */
    public
    function getDependecies($package) {
        if (!isset($this->packages[$package]))
            throw new InvalidPackageException("The package '$package' is missing.");
